! function (t, e) {
    ...
    return new Promise(function (r, n) {
      if (void 0 === t && n("Target element is undefined"), "true" !== t.getAttribute("data-scramble-active")) {
        ...
        var o, a = t.innerHTML,
          ...
          b = !1;
        v(e.text) ? o = x(e.text) : t.getAttribute("data-scramble-text") && "" !== t.getAttribute("data-scramble-text") && (o = x(t.getAttribute("data-scramble-text"))), o && (b = !0, u = o.truth, s = o.newLetters, c = o.startText);
        var h = function () {
          if (c.map(function (e, r) {
              return !(" \t\n\r\v".indexOf(e) > -1) && (s[r] = p(), !0 === i[r] && (s[r] = u[r]), t.textContent = s.join(""), !0)
            }), y(s, u)) {
            if (t.innerHTML = a, b) {
              var n = t.children[0];
              n && "" !== n ? n.textContent = s.join("") : t.textContent = s.join("")
            }
  ...
  function c(t) {
    ...
    r.beforeAll && r.beforeAll(n), Promise.all(o).then(function (t) {
  ...
  var l = function (t) {
    ...
    m = function (t) {
      return !d(t) && !s(t) && "number" != typeof t && "function" != typeof t && void 0 !== t
    },
    p = function (t, e) {
      var r = t || 1,
        n = e || !1,
        o = Math.random().toString(36).replace(/[^a-z]+/g, "").substr(0, r);
      return " \t\n\r\v".indexOf(o) < 0 && !0 !== n && o
    },
    g = function (e, r, n) {
      var o = e || !1,
        a = n || 100;
      if (o && d(r) && r.length > 1) {
        var i = t(r, 2),
          f = i[0],
          u = i[1];
        if ((n >= u || a >= u) && (a = u - 1), u -= a, f > u && (f = u), h(f) && h(u)) return Math.floor(Math.random() * (u - f)) + f
      }
    ...
    x = function (t) {
      ...
      return n.forEach(function (t, e) {
        " \t\n\r\v".indexOf(n[e]) > -1 ? a.push(" ") : a.push(p())
      }), e = a, {
        truth: n,
        newLetters: o,
        startText: e
